...
public class ExcelCodeCreater
{
    ...
    public static string CreateCodeStrByExcelData(ExcelMediumData excelMediumData)
    {
        ...
        //行数据类名
        string itemClassName = excelMediumData.className + "ExcelItem";
        //整体数据类名
        string dataClassName = excelMediumData.className + "ExcelData";
    ...
    private static string CreateExcelAssetClass(ExcelMediumData excelMediumData)
    {
        string itemClassName = excelMediumData.className + "ExcelItem";
        string dataClassName = excelMediumData.className + "ExcelData";
        string assignmentClassName = excelMediumData.className + "AssetAssignment";
        ...
        classSource.AppendLine($"\t\tstring fullPath = Path.Combine(excelAssetPath,excelMediumData.excelName) + \".asset\";");
