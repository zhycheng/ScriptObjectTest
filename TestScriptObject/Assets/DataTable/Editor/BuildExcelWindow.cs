...
{
    [MenuItem("数据表/打开窗口", priority = 100)]
    ...
    private void GetPaths()
    {
        ...
        excelReadAbsolutePath = Application.dataPath.Replace(projectName+"-client/Assets", "/"+ projectName + "-plan/");
        ...
        assetSaveRelativePath = CheckEditorPath("Assets/Resources/Excel/AutoCreateAsset");
    }
    ...
    private void OnGUI()
    {
        ...
        //Excel列表
        GUILayout.Label("说明：plan目录需要和client目录在同一个根目录下");
        GUILayout.Space(5);
